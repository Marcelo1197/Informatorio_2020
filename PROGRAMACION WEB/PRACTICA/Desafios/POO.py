...
class Agenda():
	...
	def buscar_contacto(self, nombre, apellido):
		...
		for i, contacto in self.contactos:
...
def buscar_contacto_funcion(agenda):
	...
	contacto_encontrado = agenda_marcelo.buscar_contacto(nombre_busqueda, apellido_busqueda)
...
print("\n\nMENÚ DE GESTIÓN DE LA AGENDA".center(ancho_terminal))
print("Elija una opción (o 0 para salir):\n")
opcion = int(input("\n01-Agregar contacto\n02- Lista de contactos \n03- Buscar contacto\n04- Editar contacto\n05- Cerrar agenda\n\n"))
while opcion != 5:
	if opcion == 1:
		agregar_contacto_funcion(agenda_marcelo)
